<template>
  <AdminLayout title="Sections">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
          ...
          <tr v-for="section in sections.data" :key="section.id">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <span
                ...
                :class="{
                  'bg-green-100 text-green-800': section.is_active,
                  'bg-gray-100 text-gray-800': !section.is_active
                }"
              >
      ...
      <!-- Pagination -->
      <div v-if="sections.links && sections.links.length > 3" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
        <div class="flex justify-between items-center">
          <div class="text-sm text-gray-700">
            Showing {{ sections.from }} to {{ sections.to }} of {{ sections.total }} results
          </div>
