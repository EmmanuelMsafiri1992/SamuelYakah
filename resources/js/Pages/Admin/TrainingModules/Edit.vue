<template>
  <AdminLayout :title="`Edit Training Module: ${trainingModule.title}`">
    <div class="max-w-3xl">
...
const form = useForm({
  title: props.trainingModule.title,
  description: props.trainingModule.description,
  content: props.trainingModule.content,
  duration: props.trainingModule.duration,
  order: props.trainingModule.order,
  is_active: props.trainingModule.is_active
})
