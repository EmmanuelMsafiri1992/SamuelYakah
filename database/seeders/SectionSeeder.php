    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                ...
                'translations' => [
                    'en' => [
                        'title' => 'Why Choose a Career with Helping Hands?',
                        'subtitle' => 'Discover the comprehensive benefits package designed for your wellbeing',
                        'content' => 'At Helping Hands, we believe that exceptional care starts with exceptional support for our carers. We offer one of the most comprehensive benefits packages in the industry, combining competitive financial rewards with genuine work-life balance and continuous professional development. Our carers are the heart of what we do, and we invest in your success, wellbeing, and career growth every step of the way.',
                    ],
                    'pl' => [
                        'title' => 'Dlaczego Warto Wybrać Karierę z Helping Hands?',
                        'subtitle' => 'Odkryj kompleksowy pakiet benefitów zaprojektowany dla Twojego dobrego samopoczucia',
                        'content' => 'W Helping Hands wierzymy, że wyjątkowa opieka zaczyna się od wyjątkowego wsparcia dla naszych opiekunów. Oferujemy jeden z najbardziej kompleksowych pakietów benefitów w branży, łączący konkurencyjne nagrody finansowe z prawdziwą równowagą między pracą a życiem oraz ciągłym rozwojem zawodowym. Nasi opiekunowie są sercem tego, co robimy, i inwestujemy w Twój sukces, dobrostan i rozwój kariery na każdym kroku.',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'translations' => [
                    'en' => [
                        ...
                        'subtitle' => 'Hear from the people who make Helping Hands special',
