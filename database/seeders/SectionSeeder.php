    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                ...
                'translations' => [
                    'en' => [
                        'title' => 'Why Choose a Career with Violetta Home Care Limited?',
                        'subtitle' => 'Discover the comprehensive benefits package designed for your wellbeing',
                        'content' => 'At Violetta Home Care Limited, we believe that exceptional care starts with exceptional support for our carers. We offer one of the most comprehensive benefits packages in the industry, combining competitive financial rewards with genuine work-life balance and continuous professional development. Our carers are the heart of what we do, and we invest in your success, wellbeing, and career growth every step of the way.',
                    ],
                    'pl' => [
                        'title' => 'Dlaczego Warto Wybrać Karierę z Violetta Home Care Limited?',
                        'subtitle' => 'Odkryj kompleksowy pakiet benefitów zaprojektowany dla Twojego dobrego samopoczucia',
                        'content' => 'W Violetta Home Care Limited wierzymy, że wyjątkowa opieka zaczyna się od wyjątkowego wsparcia dla naszych opiekunów. Oferujemy jeden z najbardziej kompleksowych pakietów benefitów w branży, łączący konkurencyjne nagrody finansowe z prawdziwą równowagą między pracą a życiem oraz ciągłym rozwojem zawodowym. Nasi opiekunowie są sercem tego, co robimy, i inwestujemy w Twój sukces, dobrostan i rozwój kariery na każdym kroku.',
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'translations' => [
                    'en' => [
                        ...
                        'subtitle' => 'Hear from the people who make Violetta Home Care Limited special',
                    ...
                    'pl' => [
                        ...
                        'subtitle' => 'Usłysz od ludzi, którzy czynią Violetta Home Care Limited wyjątkowym',
                        'content' => 'Nie wierz nam tylko na słowo - usłysz bezpośrednio od naszych doświadczonych opiekunów o ich satysfakcjonujących karierach z Violetta Home Care Limited. Nasi członkowie zespołu dzielą się swoimi doświadczeniami wprowadzania prawdziwej zmiany, budowania znaczących relacji z klientami i cieszenia się wsparciem i korzyściami, które wiążą się z byciem częścią rodziny Violetta Home Care Limited. Od osób zmieniających karierę, które znajdują swoje prawdziwe powołanie, po doświadczonych profesjonalistów rozwijających swoje umiejętności, każdy opiekun ma unikalną historię rozwoju, spełnienia i pozytywnego wpływu.',
                    ],
                ],
            ],
            [
